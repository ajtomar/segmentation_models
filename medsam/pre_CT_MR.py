...
parser.add_argument("-img_name_suffix", type=str, default=".nii.gz",
...
parser.add_argument("-img_path", type=str, default="path to img dir",
                    help="Path to the nii images, [default: data/FLARE22Train/images]")
parser.add_argument("-gt_path", type=str, default="pato label dir",
                    help="Path to the ground truth, [default: data/FLARE22Train/labels]")
parser.add_argument("-output_path", type=str, default="path to out dir",
...
# invalid_files = ['0002','0003','0004','0017','0025','0026','0032','0036','0038','0043','0054','0057','0059','0099','0106','0235','0241',
#                  '0245','0246','0248','0252','0256','0293','0294','0075','0078','0018','0061','0254','0289']
...
def preprocess(name, npz_path):
    ...
    # if image_name[:4] in invalid_files:
    #     return
    gt_name = name
    print('image_name: ',image_name[:4])
    # return
