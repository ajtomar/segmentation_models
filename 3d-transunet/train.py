...
def main():
    ...
    parser.add_argument("--task", default="Task111_GBC", help="can be task name or task id")
    parser.add_argument("--task_pretrained", default="Task111_GBC", help="option Task801_WORD, Task850_ABD1K")
    ...
    parser.add_argument("--valbest", required=False, default=True, action="store_true", help="")
    ...
    parser.add_argument('--max_num_epochs', default=30, type=int)
    ...
    parser.add_argument("--val_final", default=True, action="store_true", help="")
    ...
    parser.add_argument('--n_class', default=2, type=int, help="17 for WORD including background")
    ...
    print('args_config.config: ',args_config.config)
